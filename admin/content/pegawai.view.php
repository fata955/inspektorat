    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">List Pegawai</h5>
                    <nav>
    ...
    <div class="modal fade" id="modaldemo8edit">
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="proses/pegawai/executepegawai.php?action=updateData" method="post" id="editForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body text-start">
                        ...
                        <div class="input-group">
                            <select class="form-control" class="form-select rounded-pill" aria-label="Default select example" name="jabatan" id="jabatan">
                                ...
                                while ($fetch = mysqli_fetch_array($jaba)) {
