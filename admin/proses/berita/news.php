...
if ($_GET["action"] === "insertData") {
  ...
  $judul = mysqli_real_escape_string($koneksi, $_POST["isi"]);
  $judul = mysqli_real_escape_string($koneksi, $_POST["user"]);
  $judul = mysqli_real_escape_string($koneksi, $_POST["tanggal"]);
  $judul = mysqli_real_escape_string($koneksi, $_POST["status"]);
