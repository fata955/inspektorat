<header id="header" class="header sticky-top">
  ...
  <div
    class="branding text-dark"
    style="background-image: url('assets/img/kelor.png'); background-size: 20%"
  >
    <div
    ...
    >
      <a href="/inspektorat" class="logo d-flex align-items-center">
        ...
        <h1 class="sitename">Inspektorat Kota Palu<br /></h1>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown">
            ...
            ></a>
            <ul>
              <li><a href="/inspektorat/galeri">Foto</a></li>
              <li class="dropdown">
                <a href="#"
                  ><span>Deep Dropdown</span>
                  <i class="bi bi-chevron-down toggle-dropdown"></i
          ...
          <li><a href="/inspektorat/contact">Kontak</a></li>
        </ul>
